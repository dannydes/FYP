 ...
 */
class RoadNetworkUnion(n1: RoadNetwork, n2: RoadNetwork) extends DefaultDirectedGraph[Node, PartialLane](classOf[PartialLane]) {
   ...
   */
  override def edgeSet = lanes.asInstanceOf[util.Set[PartialLane]]
